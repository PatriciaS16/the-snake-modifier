...
A modern take on the classic Snake game built in Java. Our team enhanced the traditional gameplay with special food items, double score mode, a cheat code, an Easter egg, background music, and a persistent high score system.
